...
export class GradeSelectPage extends Base {
  ...
  async getAllGradeDataInSection(sectionLocator: Locator): Promise<Array<{
    name: string;
    href: string;
    gradeValue: string;
    prefecture: string;
  ...
  async getAllGradeData(): Promise<Array<{
    name: string;
    href: string;
    gradeValue: string;
    prefecture: string;
  ...
  async getGradesByValuePattern(pattern: RegExp): Promise<Array<{
    name: string;
    href: string;
    gradeValue: string;
    prefecture: string;
  ...
  async getSingleGrades(): Promise<Array<{
    name: string;
    href: string;
    gradeValue: string;
    prefecture: string;
  ...
  // Get "すべて" options
  async getAllOptions(): Promise<Array<{
    name: string;
    href: string;
    gradeValue: string;
    prefecture: string;
